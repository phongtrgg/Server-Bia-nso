...
public float dameDown() {
    ...
    public long DefendBang(){
        long dfng= 0;
        dfng += this.getPramItem(44);
        dfng += this.getPramItem(130);
        dfng += this.getPramSkill(25);
        dfng += this.getPramSkill(35);
        dfng += this.getPramSkill(69);
        dfng += this.getPramSkill(70);
        return dfng;
    }
