...
public class ItemLeave {
    ...
    public static short[] arrItemSuKienTet = new short[] {638, 639,641,642,987,770,769,907,907};
    public static short[] arrItemSuKienTet1 = new short[] {770,769,907};
    public static short[] arrItemSuKienTet2 = new short[] {454};
    public static short[] arrItem8thang3 = new short[] {386,387,388};
    public static short[] arrItemNcbk = new short[] {530};
    
    // item boss 8,8,8,8,8,9,9,9,9,9,275,276,601,601,596,596,603,603,603,603,603,277,278,443,958,958,958,959,959,959,443,443,485,485,524,454,283,456,456,455,455,455,455,455,829,907,873,874,868,862,841,842,843,838,839,545,682,657,658,659,656,839,540,545,547,910,911,912,913,914,915,916,917
    public static short[] arrItemBOSS = new short[] {9};
    public static short[] arrItemBOSSTuanLoc = new short[]  {275,276,277,278,443,443,603,443,485,485,958,958,958,959,524,455,456,457,283,456,456,455,455,455,455,455,829,907,873,874,868,862,841,842,843,838,839,545,682,657,658,659,656,839,540,545,547,910,911,912,913,914,915,916,917,869};
    ...
    public static short[] arrItemmapdong = new short[]{598,987,638,639,641,642,996,997,998,999,1000,1001,1002};
    public static short[] arrItemmapbachkim = new short[]{598,987,638,639,641,642,996,997,998,999,1000,1001,1002};
    public static short[] arrItemmaptinhanh = new short[]{598,987,638,639,641,642,996,997,998,999,1000,1001,1002};
    public static short[] arrItemmapsieupham = new short[]{598,987,638,639,641,642};
    public static short[] arrItemmaplenhbai = new short[]{};
    public static short[] arrItemmapdianguc = new short[]{996,997,998,999,1000,1001,1002,598,638,639,641,642,987};
...
//            }
 ...
 public static void addOption(Item item, int id, int param) {
    ...
    public static void leaveItemSuKien(TileMap place, Mob mob3, int master) {
        ItemMap im = null;
        int per = Util.nextInt(50);
        int per2 = Util.nextInt(150);
        int per3 = Util.nextInt(2000);
        try {
            switch (Server.manager.event) {
                ...
                case 4:{
                   if(per2 == 25) {
                        im = place.LeaveItem(arrItemSuKienTet1[Util.nextInt(arrItemSuKienTet1.length)], mob3.x, mob3.y, mob3.templates.type, false); 
                    }
                   if(per2 == 251) {
                        im = place.LeaveItem(arrItemSuKienTet2[Util.nextInt(arrItemSuKienTet2.length)], mob3.x, mob3.y, mob3.templates.type, false); 
                    }
                    if(per == 20 ) {
    ...
    public static void leaveManhThanBinh(TileMap place, Mob mob3, int master) {
        try {
             if(Util.nextInt(7000) == 3416) {
            ItemMap im = place.LeaveItem((short) 839, mob3.x, mob3.y, mob3.templates.type, mob3.isboss);
            if(im != null) {
                im.item.quantity = 1;
                im.item.isLock = false;
                im.master = master;
...
//    }
    ...
    public static void leaveDiHoc(TileMap place, Mob mob3, int master) {
        ItemMap im = null;
        try {
            if(Util.nextInt(1000) == 346) {
                //tinh thạch trung
                im = place.LeaveItem((short)1027, mob3.x, mob3.y,mob3.templates.type, false);
                 if(im != null) {
                     im.item.isLock = false;
                     im.item.quantity = 1;
                     im.master = master;
    ...
    public static void leaveDiHoc2(TileMap place, Mob mob3, int master) {
        ItemMap im = null;
        try {
            if(Util.nextInt(1000) == 346) {
                //tinh thạch trung
                im = place.LeaveItem((short)1028, mob3.x, mob3.y,mob3.templates.type, false);
                 if(im != null) {
                     im.item.isLock = false;
                     im.item.quantity = 1;
                     im.master = master;
    ...
    public static void leaveDiHoc3(TileMap place, Mob mob3, int master) {
        ItemMap im = null;
        try {
            if(Util.nextInt(1000) == 346) {
                //tinh thạch trung
                im = place.LeaveItem((short)1029, mob3.x, mob3.y,mob3.templates.type, false);
                 if(im != null) {
                     im.item.isLock = false;
                     im.item.quantity = 1;
                     im.master = master;
    ...
    public static void leaveManhDo(TileMap place, Mob mob3, int master) {
        ItemMap im = null;
        try {
            if(Util.nextInt(1000) == 346) {
                //tinh thạch trung
                im = place.LeaveItem((short)1031, mob3.x, mob3.y,mob3.templates.type, false);
                 if(im != null) {
                     im.item.isLock = false;
                     im.item.quantity = 1;
                     im.master = master;
        ...
        public static void leaveTBTHU(TileMap place, Mob mob3, int master) {
        ItemMap im = null;
        try {
            if(Util.nextInt(100) == 46) {
                //tinh thạch trung
                im = place.LeaveItem((short)1041, mob3.x, mob3.y,mob3.templates.type, false);
                 if(im != null) {
                     im.item.isLock = false;
                     im.item.quantity = 1;
                     im.master = master;
    ...
    public static void leaveItemBOSS(TileMap place, Mob mob3, int master) {
        ...
        try {
            if (Util.nextInt(10) == 1) {
                im = place.LeaveItem((short) 769, mob3.x, mob3.y, mob3.templates.type, true);
                if(im != null) {
                    im.item.quantity = 1;
                    im.item.isLock = false;
                    im.master = master;
            ...
            if (Util.nextInt(10) == 2) {
                im = place.LeaveItem((short) 770, mob3.x, mob3.y, mob3.templates.type, true);
                if(im != null) {
                    im.item.quantity = 1;
                    im.item.isLock = false;
                    im.master = master;
            ...
            if (Util.nextInt(10) == 7) {
                im = place.LeaveItem((short) 907, mob3.x, mob3.y, mob3.templates.type, true);
                if(im != null) {
                    im.item.quantity = 1;
                    im.item.isLock = false;
                    im.master = master;
    ...
    public static void leaveItemBOSSTuanLoc(TileMap place, Mob mob3, int master) {
        ...
        try {
            ...
            if (Util.nextInt(10) < 1) {
                ...
                im = place.LeaveItem((short) 454, mob3.x, mob3.y, mob3.templates.type, true);
                if(im != null) {
                    im.item.quantity = 1;
                    im.item.isLock = false;
                    im.master = master;
