   ...
   // }
            ...
            synchronized (Server.LOCK_MYSQL) {
                ...
                if (red != null && red.first()) {
                    ...
                    if (lock != 0 && lock == 1) {
                        ...
                        conn.sendMessageLog("Tài khoản bị âm lượng mày hãy ibox ad !");
                        return null;
                    }
                    if (ban >= 1) {
                    ...
                    if (p != null) {
                        ...
                        if (name.size() >= 5 && !name.contains(user)) {
                            conn.sendMessageLog("Mỗi IP chỉ được login tối đa 5 acc cùng 1 lúc");
                            return null;
                        }
                            }
                    p = new Player();
    ...
    public void sendInfo() {
        ...
        try {
            ...
            if(c.xu < 0){
               conn.sendMessageLog("Tài khoản bị âm xu mày hãy ibox ad !");
                        int TimeSeconds = 5 ;
                    while (TimeSeconds > 0) {
                            TimeSeconds--;
                           Thread.sleep(5000l);
