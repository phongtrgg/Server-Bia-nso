...
public class Mob {
    ...
    public void handleAfterCharFight(Char _char) {
        ...
        if(this.templates.id == 230 && this.tileMap.map.bossTuanLoc != null) {
          ...
          if(pkoolvn <= 10){
           long luongUp1 = Util.nextInt(1,25);
        ...
        byte pkoolvn = (byte) Util.nextInt(1, 100);
       if(pkoolvn <= 30){
       long luongUp2 = Util.nextInt(1,25);
        ...
        byte pkoolvn = (byte) Util.nextInt(1, 100);
       if(pkoolvn <= 50){
       long luongUp3 = Util.nextInt(1,30);
        ...
        _char.p.c.luongTN += luongUp3;
           ...
           byte pkoolvn = (byte) Util.nextInt(1, 100);
       if(pkoolvn <= 10){
       long luongUp4 = Util.nextInt(1,51);
       ...
       byte pkoolvn = (byte) Util.nextInt(1, 100);
       if(pkoolvn <= 30){
       long luongUp5 = Util.nextInt(1,51);
       ...
       byte pkoolvn = (byte) Util.nextInt(1, 100);
       if(pkoolvn <= 50){
       long luongUp6 = Util.nextInt(1,51);
       ...
       byte pkoolvn = (byte) Util.nextInt(1, 100);
       if(pkoolvn <= 10){
       long luongUp7 = Util.nextInt(1,101);
       ...
       byte pkoolvn = (byte) Util.nextInt(1, 100);
       if(pkoolvn <= 30){
       long luongUp8 = Util.nextInt(100,101);
        ...
        byte pkoolvn = (byte) Util.nextInt(1, 100);
       if(pkoolvn <= 50){
       long luongUp9 = Util.nextInt(1,101);
        ...
        byte pkoolvn = (byte) Util.nextInt(1, 100);
       if(pkoolvn <= 50){
       long luongUp10 = Util.nextInt(1,101);
        ...
        _char.p.c.luongTN += luongUp10;
            ...
            }else if (this.tileMap.map.id == 180){
                ItemLeave.leaveDiHoc(this.tileMap, this, master);
            }else if (this.tileMap.map.id == 181){
                ItemLeave.leaveDiHoc2(this.tileMap, this, master);
            }else if (this.tileMap.map.id == 182){
                ItemLeave.leaveDiHoc3(this.tileMap, this, master);
                }
            else if (this.tileMap.map.id == 184){
                ItemLeave.leaveManhDo(this.tileMap, this, master);
                }
            else if (this.tileMap.map.id == 185 && this.numplayers > 4){
                ItemLeave.leaveTBTHU(this.tileMap, this, master);
                }
            ...
            if (this.isboss) {
                ...
                //    Service.chatKTG(_char.name + " đã tiêu diệt " + this.templates.name);
                    ...
                    ItemLeave.leaveManhThanBinh(this.tileMap, this, master);
                }
