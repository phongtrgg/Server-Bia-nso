...
public class Char extends Body {
    ...
    public long diemluyendan = 0;
    public long bia333 = 0;
    public long expTN = 0;
    ...
    public long dihoc = 0L;
    public long expdihoc = 0L;
    public int lvnt = 0;
        ...
        try {
            synchronized(Server.LOCK_MYSQL) {
                ...
                if (red != null && red.first()) {
                    ...
                    nja.diemluyendan = red.getInt("diemluyendan");
                    nja.bia333 = red.getInt("bia333");
                     nja.vip = red.getInt("vip");
                    nja.expCS = red.getLong("expCS");
                    nja.chuyenSinh = red.getInt("chuyenSinh");
                    ...
                    nja.dihoc = red.getLong("dihoc"); 
                    nja.expdihoc = red.getLong("expdihoc"); 
    ...
    public void flush() {
        ...
        try {
            synchronized(Server.LOCK_MYSQL) {
                ...
                sqlSET = sqlSET + ",`timeRemoveClone` = "+this.timeRemoveClone+  ",`isHangDong6x` = "+this.isHangDong6x+ ",`ldgtID` = "+this.ldgtID+",`pointBossTL` = "+this.pointBossTL+ ",`maxPointCT` = "+this.isTakePoint+",`clan`='" + jarr.toJSONString() + "',`denbu`=" + this.denbu + ",`newlogin`='" + Util.toDateString(this.newlogin) + "',`ddClan`=" + this.ddClan + ",`caveID`=" + this.caveID + ",`nCave`=" + this.nCave + ",`pointCave`=" + this.pointCave + ",`useCave`=" + this.useCave + ",`bagCaveMax`=" + this.bagCaveMax + ",`itemIDCaveMax`=" + this.itemIDCaveMax + ",`saveBXH`=" + this.saveBXH + ",`exptype`=" + this.exptype + ",`bia333`=" + this.bia333 + ",`diemcauca`=" + this.diemcauca + ",`luongTN`=" + this.luongTop + ",`expCS`=" + this.expCS + ",`chuyenSinh`=" + this.chuyenSinh + ",`diemhoado`=" + this.diemhoado+ ",`diemhoavang`=" + this.diemhoavang+ ",`diemhoaxanh`=" + this.diemhoaxanh +",`diemtanghoa`=" + this.diemtanghoa + ",`exptutien`=" + this.exptutien + ",`leveltutien`=" + this.leveltutien + ",`vip`=" + this.vip +  ",`expttd`=" + this.expttd + ",`lvttd`=" + this.lvttd +  ",`lvnhc`=" + this.lvnhc +  ",`expkm`=" + this.expkm  + ",`exphl`=" + this.exphl + ",`lvnt`=" + this.lvnt+ ",`lvph`=" + this.lvph+ ",`expnt`=" + this.expnt  + ",`diemluyendan`=" + this.diemluyendan + ",`lvhc`=" + this.lvhc + ",`lvkm`=" + this.lvkm + ",`sachadmin`=" + this.sachadmin + ",`dame`=" + p.c.dameMax() + ",`tiemnang`=" +( this.ppoint + this.potential0+ this.potential1+ this.potential2+ this.potential3) + ",`expgm`=" + this.expgm + ",`theluc`=" + this.theluc + ",`yeukhi`=" + this.yeukhi + ",`cailao`=" + this.cailao + ",`dihoc`=" + this.dihoc +",`expdihoc`=" + this.expdihoc  +"";
