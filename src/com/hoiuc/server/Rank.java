...
public class Rank {
    ...
    public static void initBXH(int type) {
             ...
             case 8: {
              ...
              case 9: {
               ...
               case 10: {
                ...
                try {
                    int i = 1;
                    red = SQLManager.stat.executeQuery("SELECT `name`,`bia333` FROM `ninja` WHERE (`bia333` > 0) ORDER BY `bia333` DESC LIMIT 10;");
                    while (red.next()) {
                        String name = red.getString("name");
                        int bia333 = red.getInt("bia333");
                        Entry bXHE = new Entry();
                        bXHE.nXH = new long[2];
                        bXHE.name = name;
                        bXHE.index = i;
       ...
       case 11: {
                ...
                try {
                    int i = 1;
                    red = SQLManager.stat.executeQuery("SELECT `name`,`diemluyendan` FROM `ninja` WHERE (`diemluyendan` > 0) ORDER BY `diemluyendan` DESC LIMIT 10;");
                    while (red.next()) {
                        String name = red.getString("name");
                        int diemluyendan = red.getInt("diemluyendan");
                        Entry bXHE = new Entry();
                        bXHE.nXH = new long[2];
                        bXHE.name = name;
                        bXHE.index = i;
                        bXHE.nXH[0] = diemluyendan;
                        bxh.add(bXHE);
                        i++;
                    }
                }
