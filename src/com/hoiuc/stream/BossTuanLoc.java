                ...
                synchronized (this.ninjas) {
                    for(int i = 0; i < this.ninjas.size(); ++i) {
                        if (this.ninjas.get(i) != null) {
                            (this.ninjas.get(i)).p.setTimeMap((int)(this.time - System.currentTimeMillis()) / 10000);
                            this.ninjas.get(i).p.sendAddchatYellow("Đã tiêu diệt boss Tuần Lộc thành công. Bạn có 5p giây để thu thập vật phẩm.");
